...
export const TRANSLATIONS = {
  EN: {
    ...
    hero: {
      badge: "HOOKA - der Neuro-Hook Generator",
      titleLine1: "STOP THE",
      titleLine2: "SCROLL.",
    ...
    quota: {
      ...
      upgradeTitle: "Free account = unlimited",
      upgradeText: "You have used all 10 anonymous generations.",
      upgradeSubtext: "Create a free account and generate without limits.",
      contactUs: "Questions? Contact us",
      contactEmail: "mail@danielkofler.com",
      loginFirst: "Sign up free / Log in",
      orContact: "Or contact us directly",
      upgradeCta: "Log in for unlimited generations"
    },
    whyHooka: {
      navTitle: "Why Hooka",
  ...
  DE: {
    ...
    quota: {
      ...
      upgradeTitle: "Gratis-Account = unbegrenzt",
      upgradeText: "Du hast alle 10 anonymen Generierungen aufgebraucht.",
      upgradeSubtext: "Erstelle einen kostenlosen Account und generiere ohne Limit.",
      contactUs: "Fragen? Schreib uns",
      contactEmail: "mail@danielkofler.com",
      loginFirst: "Kostenlos registrieren / Einloggen",
      orContact: "Oder schreib uns direkt",
      upgradeCta: "Einloggen für unbegrenzte Generierungen"
    },
    whyHooka: {
